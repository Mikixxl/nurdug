...
(function() {
  ...
  "de": {
    ...
    "distinction_p2": "Diese Haltung schafft die Grundlage für Stabilität und Verlässlichkeit. Sie erlaubt es, Immobilienvermögen nicht nur zu halten, sondern mit Umsicht zu führen und über Zeit in ihrer Substanz wie in ihrer Ertragskraft zu stärken.",
  ...
  "fr": {
    ...
    "firm_p1": "Nurdug AG est une société holding dont l'activité porte sur l'immobilier et la location d'immobilier. Son orientation commerciale repose sur la détention patiente, la gestion attentive et le développement durable d'un patrimoine immobilier de qualité.",
    ...
    "approach_5_body": "Nous comprenons la gestion d'un patrimoine immobilier comme une obligation qui s'inscrit dans la durée. Préserver les valeurs, les développer avec mesure et les renforcer sur le long terme fait le cœur de notre conception.",
    ...
    "self_title": "Une holding au clair sur ses exigences",
    "self_p1": "Nurdug AG se comprend comme une holding portant une exigence claire, inscrite dans la durée. Nous allions la raison économique à un sens fin de la qualité, de la structure et de la pérennité. Notre but est de conduire le patrimoine immobilier dans un cadre ordonné et responsable, et de fournir ainsi une assise robuste à la pérennité de la valeur.",
    "closing": "Nurdug AG défend une détention immobilière axée sur la substance, une location responsable et la pérennité de la valeur.",
    "contact_eyebrow": "CONTACT",
    "contact_title": "Berlin",
  ...
  "es": {
    ...
    "focus_p2": "En la selección y conducción del patrimonio inmobiliario damos valor a la calidad, a la ubicación, a la sustancia y a la viabilidad a largo plazo. Lo que nos decide no es el movimiento pasajero del mercado, sino la idoneidad duradera de un bien, la estabilidad de sus usos y la solidez de su base económica.",
    ...
    "approach_5_body": "Entendemos el trato con el patrimonio inmobiliario como una obligación permanente. Preservar los valores, desarrollarlos con orden y reforzarlos a largo plazo constituye el núcleo de nuestro entendimiento.",
    ...
    "closing": "Nurdug AG defiende una tenencia inmobiliaria orientada a la sustancia, un arrendamiento responsable y la perdurabilidad del valor.",
  ...
  "it": {
    ...
    "approach_5_body": "Intendiamo la gestione del patrimonio immobiliare come un impegno duraturo. Preservare i valori, svilupparli con ordine e rafforzarli nel tempo è il nucleo della nostra comprensione di noi stessi.",
    ...
    "self_eyebrow": "AUTOCOMPRENSIONE",
    "self_title": "Una holding con un'esigenza chiara",
    "self_p1": "Nurdug AG si comprende come una holding dall'esigenza chiara e di lungo respiro. Uniamo la ragione economica a un senso fine per la qualità, la struttura e la sostenibilità. Il nostro scopo è condurre il patrimonio immobiliare entro una cornice ordinata e responsabile, offrendo così una base solida alla tenuta del valore nel tempo.",
    "closing": "Nurdug AG difende una detenzione immobiliare improntata alla sostanza, una locazione responsabile e una tenuta durevole del valore.",
  ...
  "pt": {
    ...
    "focus_p2": "Na seleção e condução do património imobiliário, damos primazia à qualidade, à localização, à substância e à viabilidade de longo prazo. O que nos decide não é o movimento passageiro do mercado, mas a idoneidade duradoura de um bem, a estabilidade das perspetivas de uso e a solidez do seu fundamento económico.",
    ...
    "approach_5_body": "Entendemos o trato do património imobiliário como uma obrigação permanente. Preservar os valores, desenvolvê-los com ordem e reforçá-los a longo prazo constitui o cerne do nosso entendimento.",
    ...
    "self_eyebrow": "AUTOCOMPREENSÃO",
    "self_title": "Uma holding com exigência clara",
    "self_p1": "A Nurdug AG compreende-se como uma holding portadora de uma exigência clara e de longo alcance. Conjugamos a razão económica com um sentido fino para a qualidade, a estrutura e a sustentabilidade. O nosso propósito é conduzir o património imobiliário num quadro ordenado e responsável, oferecendo assim uma base robusta à perenidade do valor.",
    "closing": "A Nurdug AG defende uma detenção imobiliária orientada para a substância, uma locação responsável e a perenidade do valor.",
    "contact_eyebrow": "CONTACTO",
  ...
  "nl": {
    "meta_title": "Nurdug AG - Vastgoed Holding, Berlijn",
    "meta_description": "Nurdug AG is een in Berlijn gevestigde holding die zich richt op langetermijneigendom van onroerend goed, verantwoord verhuur en duurzaam waarde.",
    "nav_firm": "Het bedrijf",
    "nav_focus": "Focus",
    "nav_approach": "Benadering",
    "nav_distinction": "Profiel",
    "nav_contact": "Contact",
    "hero_eyebrow": "Vastgoed Holding · Berlijn",
    "hero_title": "Nurdug AG",
    ...
    "firm_p1": "Nurdug AG is een holding die zich richt op onroerend goed en langetermijnbeheer van huurwoningen. Ons commercieel accent ligt op het zorgvuldige eigendom, beheer en duurzame ontwikkeling van substantiële vastgoedactiva.",
    "firm_p2": "Ons begrip van onroerend goed wordt gevormd door continuïteit, substantie en verantwoordelijkheid. Wij zien onroerend goed niet als een kortetermijnmarktpositie. Wij zien het als een reëel actief van blijvende betekenis - de waarde ervan wordt niet bepaald door de marktritme, maar door de kwaliteit, de bruikbaarheid, de verdienkracht en het vermogen om te blijven bestaan.",
    "firm_p3": "Als holding biedt Nurdug AG het structurele kader voor de ordelijke sturing van haar onroerendgoedactiviteiten. Strategisch toezicht wordt gecombineerd met economische discipline, zodat activa worden beheerd met de zorg en lange termijn die het werk vereist. Behoud van waarde, stabiliteit en vooruitkijkende ontwikkeling staan centraal.",
    "focus_eyebrow": "ONZE FOCUS",
    "focus_title": "Duidelijk gedefinieerd. Opzettelijk smal.",
    "focus_p1": "De activiteit van Nurdug AG is opzettelijk smal. Wij concentreren ons op onroerend goed en professionele verhuur, op gezond langetermijnbeheer.",
    ...
    "approach_4_title": "Betrouwbare beheer",
    ...
    "approach_5_body": "Wij begrijpen de behandeling van onroerendgoedkapitaal als een blijvende verplichting. Het behoud van waarde, de ontwikkeling ervan op een ordelijke manier en de versterking ervan op lange termijn is de kern van ons zelfbegrip.",
    ...
    "distinction_p2": "Deze houding is de basis van stabiliteit en betrouwbaarheid. Het stelt ons in staat om onroerendgoedkapitaal niet alleen te houden, maar ook om het met voorzichtigheid te leiden en het in de loop der tijd te versterken, zowel in zijn substantie als in zijn verdienkracht.",
    "self_eyebrow": "ZELF- BEGRIP",
    "self_title": "Een holding met standing",
    "self_p1": "Nurdug AG begrijpt zichzelf als een holding met een duidelijke en blijvende norm. Wij combineren economische rationaliteit met een fijn gevoel voor kwaliteit, structuur en duurzaamheid. Ons doel is om vastgoedkapitaal binnen een ordelijk en verantwoord kader te beheren en zo een veerkrachtige basis voor langetermijnwaarde te bieden.",
    "closing": "Nurdug AG staat voor substantiegericht onroerendgoedeigendom, verantwoord verhuur en langetermijnwaarde.",
    "contact_eyebrow": "CONTACT",
    ...
    "footer_tagline": "Vastgoed Holding · Berlijn",
  ...
  "pl": {
    ...
    "hero_title": "Nurdug AG",
    "hero_tagline": "Holding stworzona dla długiej perspektywy",
    "hero_sub": "Nieruchomości to nie krótkoterminowa pozycja. To poważny aktyw - posiadany z troską, zarządzany najmem z odpowiedzialnością, rozwijany z cierpliwością.",
    "firm_eyebrow": "FIRMA",
    ...
    "firm_p2": "Nasze rozumienie nieruchomości kształtuje się przez ciągłość, substancję i odpowiedzialność. Nie traktujemy nieruchomości jako krótkoterminowej pozycji rynkowej. Traktujemy ją jako poważny aktyw o trwałej wartości - jej wartość pokazana nie w rytmie rynku, ale w jej jakości, użyteczności, potencjale zarobkowym i zdolności do trwania.",
    "firm_p3": "Jako spółka holdingowa, Nurdug AG zapewnia ramy strukturalne dla uporządkowanego zarządzania działalnością nieruchomości. Nadzór strategiczny jest połączony z dyscypliną ekonomiczną, dzięki czemu aktywa są zarządzane z troską i długą perspektywą, której wymaga praca. Zachowanie wartości, stabilność i perspektywiczny rozwój znajdują się w centrum.",
    "focus_eyebrow": "NASZE SKUPIENIE",
    "focus_title": "Jasno określone. Celowo wąskie.",
    "focus_p1": "Działalność Nurdug AG jest celowo wąska. Skoncentrowaliśmy się na nieruchomościach i ich profesjonalnym najmie, na solidnym długoterminowym zarządzaniu.",
    ...
    "focus_p3": "W zarządzaniu najmem prowadzimy spokojne, profesjonalne, odpowiedzialne podejście. Celem jest odpowiednia dla rynku, niezawodna operacja, która zabezpiecza długoterminową wartość nieruchomości i generuje solidne, trwałe zwroty.",
    ...
    "approach_2_body": "Skoncentrowaliśmy się na aktywach o prawdziwej jakości i trwałym znaczeniu. Ciągłość jest dla nas ważniejsza niż krótkoterminowy pęd.",
    ...
    "approach_4_title": "Nieawaryjne zarządzanie",
    ...
    "approach_5_body": "Rozumiemy zarządzanie kapitałem nieruchomości jako trwałe zobowiązanie. Zachowanie wartości, rozwój w uporządkowany sposób i umocnienie jej na dłuższą metę jest istotą naszego rozumienia.",
    ...
    "closing": "Nurdug AG reprezentuje substancjonalną własność nieruchomości, odpowiedzialny najem i długoterminową wartość.",
    "contact_eyebrow": "KONTAKT",
    "contact_title": "Berlin",
  ...
  "ru": {
    "meta_title": "Nurdug AG - Недвижимостный холдинг, Берлин",
    ...
    "hero_eyebrow": "Недвижимостный холдинг · Берлин",
    "hero_title": "Nurdug AG",
    ...
    "firm_p2": "Наше понимание недвижимости определяется преемственностью, основательностью и ответственностью. Мы рассматриваем недвижимость не как краткосрочную рыночную позицию, а как реальный актив непреходящего значения. Её ценность выражается не в переменчивом такте рынка, но в качестве, в пригодности использования, в способности приносить доход и в способности сохраняться во времени.",
    "firm_p3": "Как холдинг, Nurdug AG задаёт структурные рамки для упорядоченного ведения своей деятельности в сфере недвижимости. В ней стратегическое видение соединяется с экономической дисциплиной и обеспечивается управление активами со всей подобающей тщательностью, ясностью и долгосрочностью. В центре стоят не волатильность и оппортунизм, а сохранение стоимости, стабильность и предусмотрительное развитие.",
    ...
    "approach_3_body": "Как холдинг мы действуем в ясных структурах, упорядоченных путях принятия решений и с высокими требованиями к хозяйственной дисциплине и ответственности.",
    ...
    "approach_5_body": "Обращение с недвижимостью мы понимаем как обязанность длительного характера. Сохранять ценности, развивать их упорядоченно и укреплять в долгосрочной перспективе - суть нашего самопонимания.",
    ...
    "footer_tagline": "Недвижимостный холдинг · Берлин",
  ...
  "tr": {
    ...
    "firm_eyebrow": "ŞİRKET",
    "firm_title": "Spekülasyondan ziyade esas",
    ...
    "focus_p3": "Kiralık yönetimde, sakin, profesyonel, sorumlu bir yaklaşım izliyoruz. Amaç, piyasa-uygun, güvenilir bir operasyon sağlayarak mülkün uzun vadeli değerini güvence altına almak ve sağlam, dayanıklı getiriler elde etmektir.",
    "approach_eyebrow": "YAKLAŞIMIMIZ",
    "approach_title": "Beş ilke",
    "approach_intro": "Nurdug AG'nin conduct'ı, klasik girişimci düşünceyi gayrimenkul disipliniyle birleştiren bir yaklaşım üzerine dayanır.",
    ...
    "approach_2_title": "İçerik",
    "approach_2_body": "Gerçek kalite ve uzun süreli alaka sahip varlıklara odaklanıyoruz. Süreklilik, kısa vadeli momentumdan daha ağır basar.",
    ...
    "approach_4_body": "Mülklerimizin kiralanması, yargı, piyasa bilgisi ve operasyonel özenle ilerler. Değerin korunması, kullanım kalitesi ve dayanıklı kazanç gücü ön plandadır.",
    "approach_5_title": "Değer için sorumluluk",
    "approach_5_body": "Gayrimenkul sermayesindeki uygulamayı uzun süreli bir yükümlülük olarak anlıyoruz. Değeri korumak, düzenli bir şekilde geliştirmek ve uzun vadeli güçlendirmek, bizim kendimizi anlamamızın özüdür.",
    "distinction_eyebrow": "BİZİ AYIRAN ŞEY",
    "distinction_title": "Sakinlik, açıklık, süreklilik",
    "distinction_p1": "Nurdug AG, sakinlik, açıklık ve süreklilik ile işaretlenen bir iş pratiği standardı temsil eder. Kısa vadeli piyasa düşüncesi veya fırsatçı bir yaklaşım izlemiyoruz. Odak noktamız, önemli gayrimenkul, profesyonel kiralama, düzenli yönlendirme ve dayanıklı bir değer anlayışıyla ilgilidir.",
  ...
  "zh": {
    ...
    "approach_5_body": "我们视不动产财富的管理为长期的承担。守护价值、有序地发展价值、长久地巩固价值,乃我们自我理解的核心。",
    "distinction_eyebrow": "我 们 的 特 色",
    "distinction_title": "从容、清晰、持恒",
    "distinction_p1": "Nurdug AG 体现着一种以从容、清晰与持恒为标的经营形态。我们不随短期市场之思,不取机会主义之径。我们的力量,在于专注于要紧之处:有分量的不动产、专业的租赁、有序的指挥,以及对价值的长久理解。",
  ...
  "zh-TW": {
    ...
    "approach_5_body": "我們視不動產財富之管理為長期之承擔。守護價值、有序地發展價值、長久地鞏固價值,乃我們自我理解之核心。",
    "distinction_eyebrow": "我 們 的 特 色",
    "distinction_title": "從容、清晰、持恆",
    "distinction_p1": "Nurdug AG 體現著一種以從容、清晰與持恆為標之經營形態。我們不隨短期市場之思,不取機會主義之徑。我們之力量,在於專注於要緊之處:有份量之不動產、專業之租賃、有序之指揮,以及對價值之長久理解。",
  ...
  "ja": {
    ...
    "approach_5_body": "不動産財産の扱いを、長きにわたる務めと理解します。価値を保ち、整然と発展させ、長きにわたって強固にしていくことは、私たちの自己理解の核にあります。",
    "distinction_eyebrow": "当 社 を 際 立 た せ る も の",
    "distinction_title": "静けさ、明晰、持続",
    "distinction_p1": "Nurdug AG が体現するのは、静けさ、明晰、そして持続に裏打ちされた企業行為の形です。私たちは短期の市場的思考にも、機会主義的な道にも従いません。私たちの強さは、肝要なものへの集中にあります。実体ある不動産、専門的な賃貸、整然たる指揮、そして価値についての持続的な理解です。",
    "distinction_p2": "この姿勢こそが安定と信頼の基礎をなします。それは不動産財産を保有するにとどまらず、分別をもって導き、時の経過の中でその実体と収益力の双方を強くしていくことを可能にするのです。",
    "self_eyebrow": "自 己 理 解",
