...
(function() {
  ...
  "ko": {
    ...
    "approach_3_body": "지주회사로서 저희는 분명한 구조, 정연한 결정 경로, 그리고 경제적 규율과 책임에 대한 높은 기준으로써 행동합니다.",
    ...
    "approach_5_body": "부동산 재산을 다루는 일을 장기적 의무로 이해합니다. 가치를 지키고, 정연하게 발전시키며, 긴 호흡으로 굳건히 만드는 것이 저희 정체성의 핵심입니다.",
    "distinction_eyebrow": "저희를 구별 짓는 것",
    "distinction_title": "고요, 명료, 지속",
    "distinction_p1": "Nurdug AG는 고요함, 명료함, 그리고 지속성을 특징으로 하는 기업 활동의 한 형태를 대변합니다. 저희는 단기 시장 사고도, 기회주의적 접근도 따르지 않습니다. 저희의 강점은 핵심에 대한 집중에 있습니다. 실체 있는 부동산, 전문적인 임대, 정연한 운영, 그리고 가치에 대한 지속적 이해가 그것입니다.",
  ...
  "ar": {
    ...
    "approach_5_body": "نفهم التعامل مع الثروة العقارية بوصفه التزاماً ممتدّاً. حفظ القِيَم، وتنميتها بانتظامٍ، وتمكينها على المدى البعيد - هذا لبّ هويّتنا.",
  ...
  "he": {
    ...
    "firm_p1": "Nurdug AG היא חברת החזקות המתמקדת בנדל\"ן וניהול השכרה לטווח ארוך. כובד המשקל העסקי שלה נח על החזקה סבלנית, ניהול זהיר ופיתוח בר-קיימא של מצבור נדל\"ן בעל תוכן.",
    "firm_p2": "תפיסת הנדל\"ן שלנו מעוצבת על ידי רציפות, תוכן ואחריות. איננו רואים בנדל\"ן עמדת שוק חולפת, כי אם נכס ממשי בעל משמעות מתמשכת. ערכו ניכר לא בקצב המשתנה של השוק, אלא באיכותו, בשימושיותו, בכושר התשואה שלו וביכולתו להחזיק מעמד לאורך זמן.",
    ...
    "focus_p2": "בבחירת נכסים ובניהולם אנו מייחסים משקל לאיכות, למיקום, לתוכן ולכדאיות ארוכת הטווח. מכריע עבורנו לא תנועתו הרגעית של השוק, אלא התאמתו המתמשכת של הנכס, יציבות אופקי השימוש שלו, ואיתנות היסוד הכלכלי שלו.",
    ...
    "approach_5_body": "אנו מבינים את הטיפול בהון הנדל\"ני כהתחייבות מתמשכת. לשמור על הערך, לפתחו בצורה מסודרת ולחזקו לאורך זמן - זהו לב זהותנו.",
    "distinction_eyebrow": "מה שמייחד אותנו",
    "distinction_title": "שלווה, בהירות, רציפות",
    "distinction_p1": "Nurdug AG מגלמת צורה של עשייה עסקית המצוינת בשלווה, בבהירות וברציפות. אין אנו הולכים אחרי חשיבת שוק קצרת טווח, ולא אחרי גישה הזדמנותית. כוחנו בהתרכזות במה שעיקרי: נדל\"ן בעל תוכן, השכרה מקצועית, הנהגה מסודרת, והבנה מתמשכת של ערך.",
    ...
    "closing": "Nurdug AG מייצגת החזקת נדל\"ן מוכוונת תוכן, השכרה אחראית ושמירת ערך לאורך זמן.",
